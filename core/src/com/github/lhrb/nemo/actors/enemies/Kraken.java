...
public class Kraken extends MultiPartActor {
    ...
    private void init() {
        addPart(new Section(0, this, 75,50, 15, 500, 
                    AnimationLoader.get().texture("boss/krake_kopf.png")) );
        addPart(new Section(1, this, 30,100, 5, 50, 
                AnimationLoader.get().texture("boss/krake_flosse1.png")) );
        addPart(new Section(2, this, 0,50, 5, 50, 
                AnimationLoader.get().texture("boss/krake_flosse2.png")) );
        addPart(new Section(3, this, 60,0, 5, 50, 
                AnimationLoader.get().texture("boss/krake_flosse3.png")) );
        addPart(new Section(4, this, 140,0, 5, 50, 
                AnimationLoader.get().texture("boss/krake_flosse4.png")) );
        addPart(new Section(5, this, 170,50, 5, 50, 
                AnimationLoader.get().texture("boss/krake_flosse5.png")) );
        addPart(new Section(6, this, 170,100, 5, 50, 
                AnimationLoader.get().texture("boss/krake_flosse6.png")) );
    ...
    private class KrakenShotB extends Shots {
        ...
        public KrakenShotB(float x, float y, float angle, Stage stage) {
            ...
            setAnimation(AnimationLoader.get().texture("shots/krakenShotB.png"));
            setSpeedMax(1200);
            setAcceleration(800);
            setShapePolygon(8);
    ...
    private class KrakenShotS extends Shots {
        ...
        public KrakenShotS(float x, float y, float angle, Stage stage) {
            ...
            setAnimation(AnimationLoader.get().texture("shots/krakenShotS.png"));
            setSpeedMax(1600);
            setAcceleration(1000);
            setShapePolygon(8);
